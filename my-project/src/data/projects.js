...
const projects = [
    { id: 1, 
      ...
      skill:"react, postgresql, node.js, tailwind.css, html, cloudflare, digital ocean",
    ...
    { id: 2,
      ...
      skill: "mixed reality, unity c#, inverse kinematic, animation rigging, motion capture, spatial computing, pose-estimation",
    ...
    { id: 3, 
      ...
      skill: "mvc, human-computer interaction, event handling, graphical user interface, object-oriented programming, user experience, mixed reality ",
      img: "/pictures/project3.jpg",
      date: "2024-04"
    },
    { id: 4, 
      ...
      skill: "human-robot interaction, human behavior, autonomous robotics, teleoperation, experiment design, qualitative/quantitative analysis ",
      img: "/pictures/project3.jpg",
      date: "2023-12"
    },
    { id: 5, 
