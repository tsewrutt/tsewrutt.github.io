                            ...
                            <>
                                <button
                                    className="absolute left-2 top-1/2 -translate-y-1/2 
                                        ...
                                        rounded-lg p-2 transition hover:bg-black/50"
                                    onClick={() =>
                                        setModalImageIndex(
                                            (modalImageIndex - 1 + selectedProject.img.length) %
                                            selectedProject.img.length
                                        )
                                    }
                                >
                                ...
                                <button
                                    className="absolute right-2 top-1/2 -translate-y-1/2 
                                        ...
                                        rounded-lg p-2 transition hover:bg-black/50"
                                    onClick={() =>
                                        setModalImageIndex((modalImageIndex + 1) % selectedProject.img.length)
                                    }
                                >
